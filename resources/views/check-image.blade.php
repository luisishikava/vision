...
<body>
    ...
    <div id="vision" class="container mg-top-40">
        ...
        <h1>Upload Imagem</h1>
        <form id="formulario" role="form" method="POST" action="{{asset('/vision/check-image-success')}}" class="form-horizontal" onsubmit="return false;" enctype="multipart/form-data">
            {{ csrf_field() }}
