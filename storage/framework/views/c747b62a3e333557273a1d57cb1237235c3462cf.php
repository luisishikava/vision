...
<body>
    ...
    <div id="vision" class="container mg-top-40">
        ...
        <h1>Upload Imagem</h1>
        <form id="formulario" role="form" method="POST" action="<?php echo e(asset('/vision/check-qrcode-success')); ?>" class="form-horizontal" onsubmit="return false;" enctype="multipart/form-data">
...
</html><?php /**PATH C:\Apache24\htdocs\vision\resources\views\check-qrcode.blade.php ENDPATH**/ ?>